...
@section('content')
    ...
    <!-- =============================================== -->
                 <!-- ADD GARDEN SECTION START -->
    <!-- =============================================== -->
    <section class="add_garden_section">
          <h3 class="text-center text_shadow">  <b>বাগান নিবন্ধন</b> </h3>
        <form action="{{route('tea.update',$garden->id)}}" method="post" enctype="multipart/form-data">
          @csrf
            @method('put')
