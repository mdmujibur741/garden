...
@foreach ($upozela as $key=>$item)
                                    ...
                                    <tr>
                                        ...
                                        <td class="d-flex"> 
                                             <div class="mx-1">
                                                  <a href="{{route('upozela.edit',Crypt::encryptString($item->id))}}" class="btn btn-sm btn-primary"> <i class="fas fa-edit text-light"></i></a>
                                             </div>
                                            <div class="mx-1">
                                             <form action="{{route('upozela.destroy',$item->id)}}" method="post">
                                                  @csrf
                                                  @method('delete')
