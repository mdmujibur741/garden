                    ...
                    <div class="card-body">
                        ...
                        @foreach ($lease as $key=>$item)
                                    ...
                                    <tr>
                                        ...
                                        <td class="d-flex"> 
                                             <div class="mx-1">
                                                  <a href="{{route('lease.edit',Crypt::encryptString($item->id))}}" class="btn btn-sm btn-primary"> <i class="fas fa-edit text-light"></i></a>
                                             </div>
                                            <div class="mx-1">
                                             <form action="{{route('lease.destroy',$item->id)}}" method="post">
                                                  @csrf
                                                  @method('delete')
